//Entering the sides
var s1 = prompt("Enter the  1st side");
var s2 = prompt("Enter the  2nd side");
var s3 = prompt("Enter the  3rd side");
var side1 = Number(s1);
var side2 = Number(s2);
var side3 = Number(s3);
//Entering the angles
var a1 = prompt("Enter the  1st angle");
var a2 = prompt("Enter the  2nd angle");
var a3 = prompt("Enter the  3rd angle");
